...
//'<input id="cover" type="hidden"><input id="name" type="hidden"><input id="page_id" type="hidden"><input id="latitude_box" type="hidden"><input id="longitude_box" type="hidden">' +
 '<input id="page_token" type="hidden"><input id="cover" class="essentials" type="hidden"><input id="submitinput" class="essentials" type="hidden"><input id="type" type="text" value="like"><input id="photo_created" class="essentials" type="hidden"><input id="imageURI" class="essentials" type="hidden"><input id="address_provided" type="hidden"><input id="name" type="hidden"><input id="page_id" type="text"><input id="latitude_box" type="hidden"><input id="longitude_box" type="hidden">' +
