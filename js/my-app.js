...
'<div id="map-canvas"></div>' +
        ...
        '<div class="content-block-title">Contact</div><div class="list-block media-list"><ul><li><a href="#" class="item-content"><div class="item-media"><img src="http://graph.facebook.com/'+ page_id +'/picture?width=120&height=120" style="border-radius:50%;margin-right:10px;"/></div><div class="item-inner"><div class="item-title-row"><div class="item-title">Facebook</div></div><div class="item-subtitle">'+ response[0][5] + response[0][6] + response[0][7] + response[0][8] + response[0][9] + response[0][10] + response[0][11]+'</div><div class="item-text">Lorem ipsum dolor sit amet...</div></div></a></li></ul></div>' +
