...
//alert(n + ' ' + time);
        ...
        '<div class="content-block-inner" style="background-color:rgba(255,255,255,.4);">' +
                     ...
                     '<div class="content-block-title"><div class="content-block-inner" style="text-align:center;">4: Set Location </div></div><div class="list-block"><ul><!-- Text inputs --><li><div class="item-content"><div class="item-inner"><label class="label-switch" onclick="showAddress();"><input type="checkbox" id="addressbox"><div class="checkbox"></div></label><div class="item-input"><input style="margin-left:20px;border:none;" onfocus="focusLocation(\'fulladdress\')" id="fulladdress" type="text" placeholder="i.e. 3 Smith St"></div></div></div></li><span id="resulta" style="border:none;"></span></ul><div class="row" style="display:none;"><div class="col-10"><id="unit_number" input type="text" placeholder="Unit"></div><div class="col-10"><id="street_number" input type="text" placeholder="Number"></div><div class="col-80"><id="street_name" input type="text" placeholder="Street"></div></div><div class="row" style="display:none;"><div class="col-80"><id="suburb" input type="text" placeholder="Suburb"></div><div class="col-20"><id="postcode" input type="number" placeholder="Postcode"></div></div><div class="row" style="display:none;"><div class="col-100"><input id="state" type="text" placeholder="State"></div></div><div class="row" style="display:none;"><div class="col-100"><input id="country" type="text" placeholder="Country"></div></div></div>'+
