...
'<div class="toolbar tabbar" style="background-color:transparent;border:none;">'+
    '<div class="toolbar-inner" style="background-color:transparent;">'+
        ...
        '</a>'+
        '<a href="#"><i class="pe-7s-camera pe-lg" onclick="addPhoto('+page_id+')"></i></a>'+
...
//'<input id="cover" type="hidden"><input id="name" type="hidden"><input id="page_id" type="hidden"><input id="latitude_box" type="hidden"><input id="longitude_box" type="hidden">' +
 '<input id="page_token" class="essentials" type="hidden"><input id="cover" class="essentials" type="hidden"><input id="submitinput" class="essentials" type="hidden"><input id="type" type="hidden" value="like"><input id="photo_created" class="essentials" type="hidden"><input id="imageURI" class="essentials" type="hidden"><input id="address_provided" type="hidden"><input id="name" class="essentials" type="hidden"><input id="page_id" class="essentials" type="hidden"><input id="latitude_box" type="hidden"><input id="longitude_box" type="hidden">' +
  '</div>'+
 ...
 '<li><div class="item-content"><div class="item-media" style="width:50px;"><label class="label-switch" onclick="commentClick()"><input type="checkbox" id="commentbox"><div class="checkbox"></div></label></div><div class="item-inner"><div class="item-input"><span style="color:hsl(0, 0%, 70%);font-size:17px;width:150px;margin-top:5px;" id="commenty_i">Require comment </span><span id="commenty_c"></span></div></div></div></li>'+
 '<li><div class="item-content" style="border:none;"><div class="item-inner"><label class="label-switch" onclick="showAddress();"><input type="checkbox" id="addressbox"><div class="checkbox"></div></label><div class="item-input" onclick="openSearch();$$(\'#fulladdress\').focus();" style="width:150px;color:hsl(0, 0%, 70%);" id="fulladdress2">Add location</div><span id="address_c"></span></div></div></li>'+
...
document.getElementById("title_c").innerHTML = '<a href="#" class="button" style="float:right;border:none;padding:0px;border-radius:50%;margin-top:10px;" onclick="getInfo(\'title\')"><i  class="pe-7s-info pe-2x"></i>';
...
document.getElementById("coverbutton").innerHTML = '<a href="#" class="button" onclick="addPhoto('+page_id+')" style="height:80px;margin:0 auto;border:none;margin-top:-100px;"><i class="pe-7s-upload pe-5x" ></i></a>';
