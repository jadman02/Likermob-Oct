...
myApp.modal({
    ...
    buttons: [
      {
        text: '<div style="background-color:#3b5998;color:white;border:30px solid #3b5998;margin:-10px;"><i class="pe-7s-like2 pe-lg"></i></div>',
        onClick: function() {
   ...
   comment(post_id,inputcomment);
    ...
    alert('Oops! Please enter a comment to get this deal...')
      ...
      {
        text: '<div style="background-color:#ff8000;color:white;border:30px solid #ff8000;margin:-10px;"><i class="pe-7s-like2 pe-lg pe-rotate-180"></i></div>',
        bold: true,
        onClick: function() {
        	myApp.swipeoutDelete('.s_'+ post_id);
        	closeButton();
