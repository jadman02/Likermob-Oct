...
//'<input id="cover" type="hidden"><input id="name" type="hidden"><input id="page_id" type="hidden"><input id="latitude_box" type="hidden"><input id="longitude_box" type="hidden">' +
 '<input id="page_token" type="text"><input id="cover" type="text"><input id="photo_created" type="text"><input id="imageURI" type="text"><input id="address_provided" type="text"><input id="name" type="text"><input id="page_id" type="text"><input id="latitude_box" type="text"><input id="longitude_box" type="text">' +
  '</div>'+
...
var country = document.getElementById("country_i").value;
  ...
  picture: 'http://smilesavers.net.au/images/'+ page_id +'_'+ photo_created +'.jpg',
