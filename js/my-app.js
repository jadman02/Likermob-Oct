...
//alert(n + ' ' + time);
        ...
        '<div class="content-block-inner" style="background-color:rgba(255,255,255,.4);">' +
                     ...
                     '<div class="content-block-title"><div class="content-block-inner" style="text-align:center;">5: Contact Details </div></div><div class="list-block"><ul><li><div class="item-content"><div class="item-inner"><div class="item-title label"><i class="pe-7s-call pe-lg"></i></div><div class="item-input"><input id="phoneinput" type="number"></div></div></div></li><li><div class="item-content"><div class="item-inner"><div class="item-title label">Email</div><div class="item-input"><input id="emailinput" type="email"></div></div></div></li><li><div class="item-content"><div class="item-inner"><div class="item-title label">Website</div><div class="item-input"><input type="url" id="websiteinput"></div></div></div></li></ul></div>'+
