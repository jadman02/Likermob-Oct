...
'<div class="slider-custom"><div class="slider-container slider-init"><div class="slider-wrapper">'+
       ...
       ' </div>'+
'<div class="item-title label" style="background-color:white;border-radius:5px;margin-left:5px;float:left;"><output name="amount" id="amount" for="rangeInput">20</output> km</div>'+
...
'<div class="item-input rangeslider" style="-webkit-transform: rotate(-90deg);margin-top: 10px;">'+
