...
//alert(n + ' ' + time);
        ...
        '<div class="content-block-inner" style="background-color:rgba(255,255,255,.4);">' +
                     ...
                     '<div class="content-block-title"><div class="content-block-inner" style="text-align:center;">Step 4: Set Location </div></div><div class="list-block"><ul><!-- Text inputs --><li><div class="item-content"><div class="item-inner" onclick="showDateTime();"><label class="label-switch"><input type="checkbox" id="checkbox"><div class="checkbox"></div></label></div><div class="item-input"><input onfocus="focusLocation(id)" id="fulladdress" type="text" placeholder="i.e. 3 Smith St"></div></div></li><span id="resulta" style="border:none;"></span><li><div class="item-content"><div class="item-input"><input id="latitude_box" type="hidden"></div></div></li><li><div class="item-content"><div class="item-input"><input id="longitude_box" type="hidden"></div></div></li></ul></div>'+
