...
//var currentDate = new Date();
        ...
        '<div class="content-block-inner" style="background-color:rgba(255,255,255,.4);">' +
                     ...
                     '<div class="content-block-title">Step 3: Schedule Post</div><br/><p>Schedule a Facebook post up to 6 months in advance</p><div class="list-block"><ul><!-- Date --><li><div class="item-content"><div class="item-inner"><div class="item-title label">Upload Date</div><div class="item-input"><input type="date"></div></div></div></li></ul></div>'+
