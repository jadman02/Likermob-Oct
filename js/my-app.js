...
myApp.modal({
   ...
   comment(post_id,inputcomment);
    ...
    alert('Oops! Please enter a comment to get this deal...')
      ...
      {
        text: '<img src="http://graph.facebook.com/'+ page_id +'/picture?width=20&height=20" style="border-radius:50%;margin-top:10px;border-right:100px solid #ff8000;border-left:100px solid #3b5998;margin:-10px;margin-left:-60px;margin:0 auto;"/>',
        onClick: function() {
          getBusiness(page_id);
