...
function getDeal(post_id,name,title,page_id,cover,singlequote,latitude,longitude,expiry) {
...
if (json[i].post_id == post_id){
	...
	mainView.loadContent(
        ...
        '        <div class="content-block-inner" style="background-color:rgba(255,255,255,.4);">' +
                      '<a href="#" class="button like-button" style="margin-top:-60px;" onclick="likeButton(\''+ post_id  +'\',\''+ expiry  +'\')"><i class="pe-7s-like2 pe-2x"></i></a>' + 
...
'<div id="map-canvas"></div>' +
        ...
        '      <div class="content-block" style="padding-top:40px;">' +
        '        <div class="content-block-inner" style="background-color:rgba(255,255,255,.4);"">' +
        '<a href="#" class="button" style="margin-top:-60px;" onclick=""><i class="pe-7s-star pe-2x"></i></a>' + 
        '<div class="content-block-title">Contact</div><div class="list-block media-list"><ul><li><a href="#" class="item-content"><div class="item-media"><img src="http://graph.facebook.com/'+ page_id +'/picture?width=50&height=50" style="border-radius:50%;margin-right:10px;"/></div><div class="item-inner"><div class="item-title-row"><div class="item-title">Facebook</div></div><div class="item-subtitle">'+ response[0][5] + response[0][6] + response[0][7] + response[0][8] + '</div><div class="item-text">'+ response[0][9] + response[0][10] + response[0][11]+'</div></div></a></li></ul></div>' +
