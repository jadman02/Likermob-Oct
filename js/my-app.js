...
function dbDeal() {
        ...
        '        <div class="content-block-inner" style="background-color:rgba(255,255,255,.4);">' +
                     ...
                     '<div style="text-align:center;margin:0 auto;width:100%;" id="add-loader-container"><span class="preloader" style="width:31px; height:31px"></span></div>'+
                       '<div class="list-block"><ul id="pages_list"></ul></div>' +
