...
//alert(n + ' ' + time);
        ...
        '<div class="content-block-inner" style="background-color:rgba(255,255,255,.4);">' +
                     ...
                     '<div class="content-block-title"><div class="content-block-inner" style="text-align:center;">Step 4: Set Location </div></div><div class="list-block"><ul><!-- Text inputs --><li><div class="item-content"><div class="item-inner"><label class="label-switch"><input onclick="showAddress();" type="checkbox" id="addressbox"><div class="checkbox"></div></label><div class="item-input"><input style="margin-left:20px;border:none;" id="fulladdress" type="text" placeholder="i.e. 3 Smith St"></div></div></div></li><span id="resulta" style="border:none;"></span><li><div class="item-content"><div class="item-inner"><div class="item-title label">Phone</div><div class="item-input"><input type="text"></div></div></div></li></ul></div>'+
