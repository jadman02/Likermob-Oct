...
var addy = document.getElementById("fulladdress2");
addy.value = '3 smith st';
...
'<form class="searchbar"><div class="searchbar-input"><input type="search" placeholder="Search for address" onkeyup="searchPlaces();" id="fulladdress"><a href="#" class="close-popup"><i class="icon icon-back"></i><span>Back</span></a><a href="#" class="searchbar-clear"></a></div><a href="#" class="searchbar-cancel"><i class="pe-7s-close-circle pe-lg"></i></a></form>'+
'<i class="pe-7s-search pe-lg" style="position:absolute:margin-top:30px;"></i>'+
...
$$( '#resulta' ).append('<li style="font-size:16px;padding-left:0px;padding-right:0px;margin-left:0px;margin-right:0px;" class="close-popup"><a href="#" onclick="saveAddress(\''+ response.predictions[i].place_id  +'\')" class="item-link"><div class="item-content"><div class="item-inner"><div class="item-title">' + response.predictions[i].description + '</div></div></div></a></li>');
}
});
