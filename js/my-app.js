...
//alert(n + ' ' + time);
        ...
        '<div class="content-block-inner" style="background-color:rgba(255,255,255,.4);">' +
                     ...
                     '<div class="content-block-title"><div class="content-block-inner" style="text-align:center;">4: Set Location </div></div><div class="list-block"><ul><!-- Text inputs --><li><div class="item-content"><div class="item-inner"><label class="label-switch" onclick="showAddress();"><input type="checkbox" id="addressbox"><div class="checkbox"></div></label><div class="item-input"><input style="margin-left:20px;border:none;" onfocus="focusLocation(\'fulladdress\')" id="fulladdress" type="text" placeholder="i.e. 3 Smith St"></div></div></div></li><span id="resulta" style="border:none;"></span></ul><li class="addresshide" style="display:none;"><div class="item-content"><div class="item-inner"><div class="item-title label">Unit Number</div><div class="item-input"><id="unit_number" input type="text"></div></div></div></li><li class="addresshide" style="display:none;"><div class="item-content"><div class="item-inner"><div class="item-title label">Street Number</div><div class="item-input"><id="street_number" input type="text"></div></div></div></li><li class="addresshide" style="display:none;"><div class="item-content"><div class="item-inner"><div class="item-title label">Street Name</div><div class="item-input"><id="street_name" input type="text"></div></div></div></li>'+
