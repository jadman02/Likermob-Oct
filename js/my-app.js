...
//alert(n + ' ' + time);
    ...
    '<ul id="pages_list"></ul>'+
                       ...
                       '<div class="list-block" style="margin-top:0px;"><ul><a href="#" class="item-link smart-select"><select name="fruits"><option value="apple" selected>Apple</option><option value="pineapple">Pineapple</option></select><div class="item-content"><div class="item-inner"><div class="item-title">Fruit</div><div class="item-after">Apple</div></div></div></a></li></ul></div>' +
