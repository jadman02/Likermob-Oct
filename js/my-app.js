...
if (json[i].post_id == post_id){
	...
	mainView.loadContent(
        ...
        '        <div class="content-block-inner" style="background-color:rgba(255,255,255,.4);">' +
                      '<a href="#" class="button like-button" style="margin-top:-70px;" onclick="likeButton(\''+ post_id  +'\',\''+ expiry  +'\')"><i class="pe-7s-like2 pe-2x"></i></a>' + 
...
'<div id="map-canvas"></div>' +
        ...
        '      <div class="content-block" style="padding-top:40px;">' +
        '        <div class="content-block-inner" style="background-color:rgba(255,255,255,.4);"">' +
        '<a href="#" class="button" style="margin-top:-70px;" onclick=""><i class="pe-7s-star pe-2x"></i></a>' + 
        '</br></br></br></br></br></br>'+
