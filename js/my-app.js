...
if(id=='title'){myApp.alert('Choose something creative between 5-20 characters.','Title');}	
if(id=='description'){myApp.alert('Create a deal for your Likers between 10-140 characters.','Deal');}	
if(id=='terms'){myApp.alert('Choose something creative, and between 5-20 characters','Terms');}	
if(id=='expiry'){myApp.alert('Choose something creative, and between 5-20 characters','Expiry');}	
if(id=='category'){myApp.alert('Choose something creative, and between 5-20 characters','Category');}
if(id=='phone'){myApp.alert('Choose something creative, and between 5-20 characters','Phone');}	
if(id=='email'){myApp.alert('Choose something creative, and between 5-20 characters','Email');}	
if(id=='website'){myApp.alert('Choose something creative, and between 5-20 characters','Website');}	
}
