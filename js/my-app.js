...
myApp.modal({
    ...
    afterText: '<input id="commentbox" type="text" placeholder="Post comment to Facebook" style="padding:10px; border-top:1px solid #ccc;width:100%;border:none;margin-top:10px;font-size:14px;">',
    buttons: [
      {
