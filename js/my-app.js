...
myApp.modal({
   ...
   comment(post_id,inputcomment);
    ...
    alert('Oops! Please enter a comment to get this deal...')
      ...
      {
        text: '<div style="margin:-10px;margin-left:-170px;margin-top:10px;"><img src="http://graph.facebook.com/'+ page_id +'/picture?width=30&height=30" style="border-radius:50%;border-right:200px solid #ff8000;border-left:200px solid #3b5998;margin:0 auto;"/></div>',
        onClick: function() {
          getBusiness(page_id);
