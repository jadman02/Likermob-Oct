...
myApp.modal({
    ...
    text: '<a class="button" style="float:right;" href="#"><i class="pe-7s-close pe-lg"></i></a><div style="clear:both;padding-left:25px;padding-right:25px;">' + clear_description + '</div>',
