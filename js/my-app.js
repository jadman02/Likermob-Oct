...
myApp.modal({
    ...
    afterText: '<input id="commentbox" type="text" placeholder="Comment on Facebook" style="text-align:center;border-radius:none;padding:20px; border-top:1px solid #ccc;border:none;margin-top:10px;font-size:14px;">',
    buttons: [
      {
