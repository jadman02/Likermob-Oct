...
$$( '#resulta' ).append('<a href="#" onclick="saveAddress(\''+ response.predictions[i].place_id  +'\')"><li class="item-content"><div class="item-inner">' + response.predictions[i].description + '</div></li></a>');
}
});
});
