...
//alert(n + ' ' + time);
        ...
        '<div class="content-block-inner" style="background-color:rgba(255,255,255,.4);">' +
                     ...
                     '<div style="text-align:center;margin:0 auto;width:100%;" id="add-loader-container"><span class="preloader"></span></div>'+
                       ...
                       '<div class="list-block" style="margin-top:0px;"><ul><li><a href="#" class="item-link smart-select"><select name="fruits" id="pages_list"></select><div class="item-content"><div class="item-inner"><div class="item-title">Fruit</div><div class="item-after">Apple</div></div></div></a></li></ul></div>' +
