...
'<div class="popup">'+
 ...
 '<div class="buttons-row" style="padding:5px;">'+
       ' <a href="#tab1" class="tab-link active button" style="padding-left:10px;padding-right:10px;"><i class="pe-7s-map-marker pe-lg"></i></a>'+
        '<a href="#tab2" class="tab-link button" style="padding-left:10px;padding-right:10px;"><i class="pe-7s-photo-gallery pe-lg"></i></a>'+
        '<a href="#tab3" class="tab-link button" style="padding-left:10px;padding-right:10px;"><i class="pe-7s-filter pe-lg"></i></a>'+
      '</div>'+
    '</div>'+
 ' </div>'+
'</div>'+
