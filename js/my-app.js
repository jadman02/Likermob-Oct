...
$$( '#resulta' ).append('<li class="item-content"><a href="#" onclick="saveAddress(\''+ response.predictions[i].place_id  +'\')"><div class="item-inner"><div class="item-title">' + response.predictions[i].description + '</div></div></a></li>');
}
});
});
