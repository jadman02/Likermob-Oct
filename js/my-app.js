...
myApp.modal({
    title: '<div style="padding-left:25px;padding-right:25px;"><img style="padding-top:5px;" src="http://graph.facebook.com/'+ page_id +'/picture?width=20&height=20" style="border-radius:50%;margin-right:10px;"/>' + title + '</div>',
