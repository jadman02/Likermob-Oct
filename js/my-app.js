...
myApp.modal({
    ...
    text: '<div class="page-content" style="margin:0;padding:0;"><div class="content-block" style="max-height:200px;overflow: scroll;"><div class="content-block-inner">' + clear_description + '<br/><br/>4444<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>sdfdfsfdds<br/><br/></div></div></div>',
   ...
   comment(post_id,inputcomment);
    ...
    alert('Oops! Please enter a comment to get this deal...')
      ...
      {
        text: '<img src="http://graph.facebook.com/'+ page_id +'/picture?width=20&height=20" style="border-radius:50%;"/>',
        onClick: function() {
          getBusiness(page_id);
