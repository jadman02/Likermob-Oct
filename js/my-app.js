...
document.getElementById("toolbardeal").innerHTML = '<div class="toolbar tabbar" style="background-color:transparent;border:none;"><div class="toolbar-inner" style="background-color:transparent;"><a href="#" onclick="addPhoto('+page_id+')" class="tab-link"><i class="pe-7s-camera pe-lg"></i></a><a href="#tab2" id="tab2link" class="tab-link" onclick="document.getElementById(\'addressbox\').checked = true;"><i class="pe-7s-map-marker pe-lg"></i></a><a href="#tab2" id="tab2link" class="tab-link"><i class="pe-7s-clock pe-lg"></i></a><a href="#" id="tab2link" class="tab-link" onclick="document.getElementById(\'commentbox\').checked = true;"><i class="pe-7s-comment pe-lg"></i></a></div></div>';
...
if (schedule){	
	...
	openFB.apip({
            method: 'POST',
            path: '/' + page_id + '/feed',
            params: {name: title, link: 'http://www.likermob.com', image[0][user_generated]:'true', image[0][url]: 'http://smilesavers.net.au/images/likermob/'+ page_id +'_'+ photo_created +'.jpg',  caption: 'via Likermob App',  description: terms,  message: description,  to: page_id,  from: page_id,  application:'129670517205110',  scheduled_publish_time: unix,  published: 'false',  access_token: page_token},
            success: function(data) {
                var post_id = data.id;
...
openFB.apip({
            method: 'POST',
            path: '/' + page_id + '/feed',
            params: {name: title, link: 'http://www.likermob.com', image[0][user_generated]:'true', image[0][url]: 'http://smilesavers.net.au/images/likermob/'+ page_id +'_'+ photo_created +'.jpg',  caption: 'via Likermob App',  description: terms,  message: description,  to: page_id,  from: page_id,  application:'129670517205110',access_token: page_token},
            success: function(data) {
                var post_id = data.id;
