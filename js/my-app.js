...
function dbDeal(page_id) {
        ...
        '        <div class="content-block-inner" style="background-color:rgba(255,255,255,.4);">' +
                     ...
                     '<i class="pe-7s-plus pe-3x " style="margin-top:-100px;"></i>' +
                     '<div class="content-block-title" style="background-color:white;margin-top:-30px;">Step 1: Select Page</div>'+
