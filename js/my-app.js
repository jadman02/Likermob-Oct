...
myApp.modal({
    ...
    afterText: '<div style="border-top:1px solid #ccc;width:100%"><input id="commentbox" type="text" placeholder="Comment on Facebook" style="margin-bottom:-15px;width:100%;border:none;text-align:center;border-radius:none;padding:20px; margin-top:-5px;font-size:14px;margin-right:-40px;"></div>',
    buttons: [
      {
