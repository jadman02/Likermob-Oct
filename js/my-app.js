...
myApp.modal({
    ...
    afterText: '<div style="width:100%;border-top:1px solid #ccc;background-color:white;"><input id="commentbox" type="text" placeholder="Enter comment" style="padding:10px; border:none;margin-top:10px;font-size:14px;"></div>',
    buttons: [
      {
