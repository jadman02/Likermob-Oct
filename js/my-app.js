...
$$('#add_button').remove();
	...
	document.getElementById("coverbutton").innerHTML = '<a href="#" class="button" onclick="addPhoto('+page_id+')" style="height:80px;margin:0 auto;border:none;margin-top:-100px;"><i class="pe-7s-plus pe-5x pe-spin" style="border-radius:50%;background-color:white;color:#007aff;"></i></a>';
	var coverpic = response["cover"]["source"];
