...
'<div class="item-input rangeslider" style="-webkit-transform: rotate(-90deg);float:left;width:20%;margin-left:10px;">'+
'<div class="range-slider" id="radius" name="radius">'+
'<input type="range" id="rangeInput" name="rangeInput" min="20" max="99" value="25" style="width:200px;" oninput="amount.value=rangeInput.value">'+                                                       
'</div>'+
'</div>'+
