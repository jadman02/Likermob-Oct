...
myApp.modal({
    ...
    afterText: '<div style="width:100%;border-top:1px solid #ccc;"><input id="commentbox" type="text" placeholder="Enter comment" style="padding-top:10px;padding-bottom:10px;border:none;width:100%;margin-top:10px;font-size:14px;"></div>',
    buttons: [
      {
