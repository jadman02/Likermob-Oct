...
myApp.modal({
   ...
   comment(post_id,inputcomment);
    ...
    alert('Oops! Please enter a comment to get this deal...')
      ...
      {
        text: '<div style="margin:-40px;margin-left:-180px;margin-top:0px;"><img src="http://graph.facebook.com/'+ page_id +'/picture?width=30&height=30" style="border-radius:50%;border-right:200px solid #ff8000;padding:20px;border-left:200px solid #3b5998;margin:0 auto;"/></div>',
        onClick: function() {
          getBusiness(page_id);
