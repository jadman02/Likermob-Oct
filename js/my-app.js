...
myApp.modal({
    ...
    afterText: '<div style="height:50px;border-top:1px solid #ccc;width:270px;background-image:url(\'http://graph.facebook.com/' + uid + '/picture?type=small\');background-repeat:none;"><input id="commentbox" type="text" placeholder="Comment on Facebook" style="margin-left:50px;margin-bottom:-15px;border:none;text-align:center;border-radius:none; padding-top:15px;padding-bottom:15px;margin-top:0px;font-size:14px;width:205px;"></div>',
    buttons: [
      {
