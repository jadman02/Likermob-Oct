...
'<a href="#" class="button disabled" id="search_button" style="position:absolute;border:none;margin:0 auto;top:50%;"><i class="pe-7s-search pe-5x" style="border-radius:50%;"></i></a>'+
'</div>'+
'</div>'
