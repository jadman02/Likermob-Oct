...
myApp.modal({
    ...
    afterText: '<div style="border-top:1px solid #ccc;width:250px;"><input id="commentbox" type="text" placeholder="Comment on Facebook" style="margin-bottom:-15px;border:none;text-align:center;border-radius:none; margin-top:0px;font-size:14px;width:250px;"></div>',
    buttons: [
      {
