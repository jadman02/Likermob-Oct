...
//var currentDate = new Date();
        ...
        '<div class="content-block-inner" style="background-color:rgba(255,255,255,.4);">' +
                     ...
                     '<div class="content-block-title"><div class="content-block-inner" style="text-align:center;">Step 3: Schedule Post </div></div><div class="list-block"><ul><li><div class="item-content"><p>Do you want to postpone this deal (up to 6 months)?</p></div></li><!-- Date --><li><div class="item-content"><div class="item-inner"><label class="label-switch"><input type="checkbox"><div class="checkbox"></div></label><div class="item-input"><input type="date"></div></div></div></li></ul></div>'+
