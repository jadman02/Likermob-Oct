...
'<a href="#" class="button disabled" id="search_button" style="position:absolute;border:none;margin:0 auto;"><i class="pe-7s-search pe-5x"></i></a>'+
'<div class="list-block" style="margin-top:-30px;background-color:transparent;"><ul id="resulta" style="border:none;padding:0px;margin:0px;"></ul></div>'+
